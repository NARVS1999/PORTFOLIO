...
const titleHeading5 = document.querySelector(".title-heading-5");
...
function darkMode() {
        ...
        workExperienceBackground.classList.toggle("work-experience-background-dark");
        ...
        titleHeading5.classList.toggle("title-heading-5-dark");
